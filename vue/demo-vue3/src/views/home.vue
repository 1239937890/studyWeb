        ...
        <div class="banner_container">
          <div class="item" @click="goTesting(testList[randomIndex].id)">
            ...
            <div>
              ...
              <div class="btn">
                {{ testList[randomIndex].aboutTime }}分钟简单一测
              </div>
            </div>
...
export default {
  ...
  setup() {
    const handleAuth = () => {
      ...
      const SHA256 = sha256.sha256;
      console.log("sha256>>>>", sha256.sha256);
      const AppKey = "u1ZSGkUuu66j6M20rC8zfA";
      const AppSecret = "00zadK8V0n7bSIurXZYO5";
      const MasterSecret = "DAEArJKYSZ8AE7swqRtOs8";
      const AppID = "RNYmku69hY6LOpC0s60aA";
      const time = new Date().getTime();
      const sign = `${AppKey}${time}${MasterSecret}`;
      //    const BaseUrl = `https://restapi.getui.com/v2/${AppID}`;
      console.log("sign>>>>>", sign);
      console.log("SHA256>>>>>", SHA256(sign));
      //  console.log(time);
      const params = {
        sign: SHA256(sign),
        timestamp: time,
